...
code::
    ...
    ALTER ROLE my_role {
        SET permissions := {
            default::data_export, frontend::webapp, sys::modifications
        };
    };
...
With current design non-SUPERUSER rols have a very limited access to the
...
role that created that function.
